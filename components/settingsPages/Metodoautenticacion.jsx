...
export const MetodoAutenticacionModal = ({
        ...
        try {
            ...
            if (empleadoId && userData?.token) {
                try {
                    ...
                    console.log('🤖 [REGISTRO FACIAL] Buscando credenciales offline debido a fallo de red local:', networkError);
                    try {
                        ...
                        console.log('🤖 [REGISTRO FACIAL] Error obteniendo credenciales de sqliteManager:', offlineErr);
                    }
                }
            }
        } catch (error) {
            console.log('🤖 [REGISTRO FACIAL] Error en cargarConfiguracion:', error);
        } finally {
            setLoading(false);
        }
    };
                    ...
                    },
                    {
                        ...
                        onPress: async () => {
                            try {
                                ...
                                showCustomAlert('¡Éxito!', 'Huella digital registrada correctamente', [
                                    {
                                        text: 'OK',
                                        onPress: () => {
    ...
    const handleFacialCaptureComplete = async (captureData) => {
        ...
        try {
            ...
            console.log('🤖 [REGISTRO FACIAL] Captura facial completada');
            ...
            if (!validation.isValid) {
                console.log('🤖 [REGISTRO FACIAL] ⚠️ Validación de calidad falló:', validation.errors);
                showCustomAlert(
            ...
            console.log('🤖 [REGISTRO FACIAL] Validación facial exitosa, generando descriptor...');
            ...
            console.log('🤖 [REGISTRO FACIAL] Guardando en el servidor u offline...');


            try {
                await guardarFacial(
                    empleadoId,
                    captureData.photoBase64, // Enviar la foto real en Base64 para que el servidor extraiga el descriptor
                    userData.token
                );
            } catch (saveError) {
                console.log('❌ [REGISTRO FACIAL] Error al guardar en el servidor:', saveError);
                ...
                throw saveError; // Lanzar el error para que muestre la alerta de fallo en pantalla
            }


            setCredenciales((prev) => ({ ...prev, tiene_facial: true }));

            showCustomAlert('¡Éxito!', 'Reconocimiento facial registrado correctamente', [
                {
                    text: 'OK',
                    onPress: () => {
            ...
            console.log('❌ [REGISTRO FACIAL] Error en registro facial:', error);
            showCustomAlert(
                'Error',
    ...
    const handleConfirmarPIN = async (pin) => {
        try {
            ...
            try {
                ...
                console.log('🤖 [REGISTRO FACIAL] Error guardando PIN localmente:', e);
            }
